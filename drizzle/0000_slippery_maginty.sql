...
--> statement-breakpoint
ALTER TABLE `seat_allocations` ADD CONSTRAINT `seat_allocations_student_id_users_id_fk` FOREIGN KEY (`student_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `seat_applications` ADD CONSTRAINT `seat_applications_student_id_users_id_fk` FOREIGN KEY (`student_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `hall_students` ADD CONSTRAINT `hall_students_room_id_rooms_id_fk` FOREIGN KEY (`room_id`) REFERENCES `rooms`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `meal_tokens` ADD CONSTRAINT `meal_tokens_student_id_users_id_fk` FOREIGN KEY (`student_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `student_dues` ADD CONSTRAINT `student_dues_student_id_users_id_fk` FOREIGN KEY (`student_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `damage_reports` ADD CONSTRAINT `damage_reports_student_id_hall_students_id_fk` FOREIGN KEY (`student_id`) REFERENCES `hall_students`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX `idx_students_room` ON `hall_students` (`room_id`);--> statement-breakpoint
...
CREATE INDEX `idx_room_number` ON `rooms` (`room_number`);--> statement-breakpoint
...
CREATE INDEX `idx_beds_room` ON `beds` (`room_number`);--> statement-breakpoint
