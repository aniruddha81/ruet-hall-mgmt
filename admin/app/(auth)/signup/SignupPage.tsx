          ...
          <div className="grid md:grid-cols-[0.95fr_1.05fr]">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Submit your institutional information to request access to
                    the administrator control panel.
                  </p>
                </div>
              </div>
              <p className="text-sm text-muted-foreground">
                Requests are reviewed by the super admin before activation.
              </p>
            </section>
            ...
            <section className="p-6 sm:p-8 lg:p-10">
              <CardHeader className="space-y-2 px-0 pt-0 text-center sm:text-left">
                ...
                <CardDescription>
                  Complete the form below to submit an access request.
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="max-h-[70vh] overflow-y-auto px-0 pb-0">
                ...
                <p className="text-sm text-muted-foreground">
                  Your request will be reviewed by the super admin and approved
                  accounts will receive a confirmation email.
                </p>
              </CardContent>
